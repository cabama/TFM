...
class Pepper:
  ...
  def calculateGiros(self, skeleto):
    pass

  ## Calcular el angulo entre dos puntos
  def __yaw(self, vector):
    return math.atan2(vector.x, -vector.y)

  def __pitch (self, vector):
  ...
  def main_carlos(self, frame):
    #skeleto = self.reskeleton(frame)
